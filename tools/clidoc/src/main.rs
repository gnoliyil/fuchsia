...
// TODO(https://fxbug.dev/69336): Move allow list to its own separate config file.
...
fn recurse_cmd_output<W: Write>(
    ...
    for line in lines {
        // TODO(https://fxbug.dev/69457): Capture all section headers in addition to "Commands" and "Options".
        match line.to_lowercase().as_str() {
            ...
            _ => {
                ...
                {
                    // TODO(https://fxbug.dev/71456): Remove filtering ffx repeated line after documentation standardized.
...
fn help_output_for(tool: &Path, subcommands: &Vec<&String>) -> Result<Vec<String>, HelpError> {
    ...
    if !combined_lines.is_empty() {
        // TODO(https://fxbug.dev/85803): This is a short term solution to prevent errantly documenting
        ...
        if first_line.contains("Unrecognized argument:") {
            // TODO(https://fxbug.dev/90561): Create Error enums to better fit these errors.
