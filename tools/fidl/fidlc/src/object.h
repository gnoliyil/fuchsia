...
#ifndef TOOLS_FIDL_FIDLC_SRC_OBJECT_H_
#define TOOLS_FIDL_FIDLC_SRC_OBJECT_H_
...
// TODO(https://fxbug.dev/42113185): Remove this Object class, since it forms a third type hierarchy
...
struct Object {
  ...
  // type erasure in C++.
  //
  // TODO(https://fxbug.dev/42113185): Refactor the visitor pattern here to be the simpler kind-enum +
  // switch() dispatch.
  template <typename T>
  struct Visitor;
...
#endif  // TOOLS_FIDL_FIDLC_SRC_OBJECT_H_
