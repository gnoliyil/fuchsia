...
TEST(TokenTests, SameToken) {
  ...
  auto token = fidl::Token(start, letter, Kind::kIdentifier, Subkind::kNone, 0);
...
TEST(TokenTests, DifferentFileDifferentToken) {
  ...
  auto token_a = fidl::Token(start_a, letter_a, Kind::kIdentifier, Subkind::kNone, 0);
  ...
  auto token_b = fidl::Token(start_b, letter_b, Kind::kIdentifier, Subkind::kNone, 0);
