...
//	|-stringNP---|-Name--------------------|
//
// TODO(fxbug.dev/118283): rename to idPart
...
// TODO(fxbug.dev/118283): move this to the top of the file since it's the most important type.
type name struct {
	name namePart
	ns   namespace
}
...
// TODO(fxbug.dev/118283): probably make this the default
