...
type Static struct {
	...
	EnableGoCache bool `protobuf:"varint,24,opt,name=enable_go_cache,json=enableGoCache,proto3" json:"enable_go_cache,omitempty"`
	// Whether to use a rust cache when building.
	EnableRustCache bool `protobuf:"varint,25,opt,name=enable_rust_cache,json=enableRustCache,proto3" json:"enable_rust_cache,omitempty"`
	// Which IDE files to generate.
	IdeFiles []string `protobuf:"bytes,26,rep,name=ide_files,json=ideFiles,proto3" json:"ide_files,omitempty"`
	// Passed to --json-ide-script GN flag; GN will execute each of these scripts
	// after regenerating the project.json IDE file.
	JsonIdeScripts []string `protobuf:"bytes,27,rep,name=json_ide_scripts,json=jsonIdeScripts,proto3" json:"json_ide_scripts,omitempty"`
	// Whether to set --export-rust-project GN flag.
	ExportRustProject bool `protobuf:"varint,28,opt,name=export_rust_project,json=exportRustProject,proto3" json:"export_rust_project,omitempty"`
	// If true, build Rust targets with RBE/reclient.
	RustRbeEnable bool `protobuf:"varint,29,opt,name=rust_rbe_enable,json=rustRbeEnable,proto3" json:"rust_rbe_enable,omitempty"`
	// If true, build C++ targets with RBE/reclient.
	// This takes precedence over `use_goma`.
	CxxRbeEnable bool `protobuf:"varint,30,opt,name=cxx_rbe_enable,json=cxxRbeEnable,proto3" json:"cxx_rbe_enable,omitempty"`
	// Whether we're performing an incremental build.
	Incremental bool `protobuf:"varint,31,opt,name=incremental,proto3" json:"incremental,omitempty"`
	// Whether to include the the default ninja target.
	IncludeDefaultNinjaTarget bool `protobuf:"varint,32,opt,name=include_default_ninja_target,json=includeDefaultNinjaTarget,proto3" json:"include_default_ninja_target,omitempty"`
	...
	UseTemporaryGoCache bool `protobuf:"varint,33,opt,name=use_temporary_go_cache,json=useTemporaryGoCache,proto3" json:"use_temporary_go_cache,omitempty"`
	// Which language-specific lint targets to include.
	IncludeLintTargets Static_LintTargets `protobuf:"varint,34,opt,name=include_lint_targets,json=includeLintTargets,proto3,enum=fint.Static_LintTargets" json:"include_lint_targets,omitempty"`
	// Extra args to pass to ninja.
	NinjaArgs []string `protobuf:"bytes,35,rep,name=ninja_args,json=ninjaArgs,proto3" json:"ninja_args,omitempty"`
	...
	HermeticTestPackages []string `protobuf:"bytes,36,rep,name=hermetic_test_packages,json=hermeticTestPackages,proto3" json:"hermetic_test_packages,omitempty"`
	...
	TestPackages []string `protobuf:"bytes,37,rep,name=test_packages,json=testPackages,proto3" json:"test_packages,omitempty"`
	...
	E2ETestLabels []string `protobuf:"bytes,39,rep,name=e2e_test_labels,json=e2eTestLabels,proto3" json:"e2e_test_labels,omitempty"`
	...
	HostTestLabels []string `protobuf:"bytes,40,rep,name=host_test_labels,json=hostTestLabels,proto3" json:"host_test_labels,omitempty"`
	...
	// empty list.
	DeveloperTestLabels []string `protobuf:"bytes,41,rep,name=developer_test_labels,json=developerTestLabels,proto3" json:"developer_test_labels,omitempty"`
	...
	// package sets.
	BuildOnlyLabels []string `protobuf:"bytes,42,rep,name=build_only_labels,json=buildOnlyLabels,proto3" json:"build_only_labels,omitempty"`
	// If true, link C/C++ targets remotely with RBE/reclient.
	LinkRbeEnable bool `protobuf:"varint,43,opt,name=link_rbe_enable,json=linkRbeEnable,proto3" json:"link_rbe_enable,omitempty"`
	// If true, enable remote builds for bazel on RBE.
	BazelRbeEnable bool `protobuf:"varint,44,opt,name=bazel_rbe_enable,json=bazelRbeEnable,proto3" json:"bazel_rbe_enable,omitempty"`
}
...
var file_static_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x6e, 0x74, 0x22, 0xf5, 0x0f, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x12,
	...
	0x68, 0x65, 0x18, 0x18, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65,
	0x47, 0x6f, 0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x2a, 0x0a, 0x11, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x5f, 0x72, 0x75, 0x73, 0x74, 0x5f, 0x63, 0x61, 0x63, 0x68, 0x65, 0x18, 0x19, 0x20, 0x01,
	...
	0x18, 0x1a, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x69, 0x64, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x73,
	0x12, 0x28, 0x0a, 0x10, 0x6a, 0x73, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x65, 0x5f, 0x73, 0x63, 0x72,
	0x69, 0x70, 0x74, 0x73, 0x18, 0x1b, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x6a, 0x73, 0x6f, 0x6e,
	...
	,
	...
	0x45, 0x4c, 0x45, 0x41, 0x53, 0x45, 0x10, 0x02, 0x22, 0x3d, 0x0a, 0x04, 0x41, 0x72, 0x63, 0x68,
	...
	0x01, 0x12, 0x07, 0x0a, 0x03, 0x58, 0x36, 0x34, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x49,
	0x53, 0x43, 0x56, 0x36, 0x34, 0x10, 0x03, 0x22, 0x53, 0x0a, 0x0b, 0x4c, 0x69, 0x6e, 0x74, 0x54,
	0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x12, 0x13, 0x0a, 0x0f, 0x4e, 0x4f, 0x5f, 0x4c, 0x49, 0x4e,
	0x54, 0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x53, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10, 0x41,
	0x4c, 0x4c, 0x5f, 0x4c, 0x49, 0x4e, 0x54, 0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x53, 0x10,
	0x01, 0x12, 0x19, 0x0a, 0x15, 0x41, 0x46, 0x46, 0x45, 0x43, 0x54, 0x45, 0x44, 0x5f, 0x4c, 0x49,
	0x4e, 0x54, 0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x53, 0x10, 0x02, 0x42, 0x35, 0x5a, 0x33,
