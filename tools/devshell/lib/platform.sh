...
readonly PREBUILT_PYTHON3_DIR="${PREBUILT_3P_DIR}/python${PYTHON_VERSION}/${HOST_PLATFORM}"
readonly PREBUILT_PYTHON3="${PREBUILT_PYTHON3_DIR}/bin/python${PYTHON_VERSION}"
