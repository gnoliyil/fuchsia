...
enum Command {
    ...
    Compile {
        ...
        // TODO(https://fxbug.dev/43400): Eventually this option should be removed when we can define this
    ...
    Test {
        ...
        // TODO(https://fxbug.dev/56774): Refer to documentation for bind testing.
