...
// See //zircon/system/ulib/zx/include/lib/zx/result.h for more information.
using fit::as_error;
using fit::error;
using fit::failed;
using fit::ok;
...
template <typename T>
class [[nodiscard]] status<T> : public ::fit::result<ACPI_STATUS, T> {
...
template <>
class [[nodiscard]] status<> : public ::fit::result<ACPI_STATUS> {
