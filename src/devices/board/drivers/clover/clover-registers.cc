...
zx_status_t Clover::RegistersInit() {
  ...
  auto mask_item1 =
      fuchsia_hardware_registers::wire::Mask::WithR32(aml_registers::A1_USB_RESET1_MASK);
  usb_masks[0] = fuchsia_hardware_registers::wire::MaskEntry::Builder(allocator)
                     .mask(mask_item1)
                     .mmio_offset(A1_RESET1_REGISTER)
                     .count(1)
                     .overlap_check_on(true)
                     .Build();

  auto mask_item2 =
      fuchsia_hardware_registers::wire::Mask::WithR32(aml_registers::A1_USB_RESET1_LEVEL_MASK);
  usb_masks[1] = fuchsia_hardware_registers::wire::MaskEntry::Builder(allocator)
                     .mask(mask_item2)
                     .mmio_offset(A1_RESET1_LEVEL)
                     .count(1)
                     .overlap_check_on(true)
                     .Build();
