...
static const gpio_pin_t gpio_pins[] = {
    ...
    DECL_GPIO_PIN(A1_SPI_A_SS0),  DECL_GPIO_PIN(A1_SDIO_D0),    DECL_GPIO_PIN(A1_SDIO_D1),
    DECL_GPIO_PIN(A1_SDIO_D2),    DECL_GPIO_PIN(A1_SDIO_D3),    DECL_GPIO_PIN(A1_SDIO_CLK),
    DECL_GPIO_PIN(A1_SDIO_CMD),   DECL_GPIO_PIN(A1_GPIOP(4)),
};
