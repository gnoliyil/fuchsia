...
#define GPIO_DDIC_DETECT T931_GPIOH(2)
...
#define GPIO_HW_ID0 T931_GPIOA(11)
#define GPIO_HW_ID1 T931_GPIOA(12)
#define GPIO_HW_ID2 T931_GPIOC(6)
#define GPIO_HW_ID3 T931_GPIOC(4)
#define GPIO_HW_ID4 T931_GPIOC(5)
