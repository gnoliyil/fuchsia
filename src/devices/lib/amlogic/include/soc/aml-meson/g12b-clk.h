...
constexpr uint32_t G12B_CLK_25M = AmlClkId(10, clk_type::kMesonGate);

constexpr uint32_t G12B_CLK_AUDIO = AmlClkId(11, clk_type::kMesonGate);
constexpr uint32_t G12B_CLK_HIFI_PLL = AmlClkId(12, clk_type::kMesonGate);
