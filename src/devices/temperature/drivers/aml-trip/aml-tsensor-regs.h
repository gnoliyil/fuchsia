...
#ifndef SRC_DEVICES_TEMPERATURE_DRIVERS_AML_TRIP_AML_TSENSOR_REGS_H_
#define SRC_DEVICES_TEMPERATURE_DRIVERS_AML_TRIP_AML_TSENSOR_REGS_H_
...
#endif  // SRC_DEVICES_TEMPERATURE_DRIVERS_AML_TRIP_AML_TSENSOR_REGS_H_
