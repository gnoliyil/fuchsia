...
class GenerateMetadataTests(unittest.TestCase):
        ...
        intermediate_data = [
            {
                ...
                "test": {
                    ...
                    "label": "unused",
                    "log_settings": {"max_severity": "unused"},
                    "name": "unused",
                    "os": "unused",
            ...
            },
            {
                "test_types": ["a", "b"],
                "id": identifier,
                "device_categories": [{"category": "d", "subcategory": "e"}],
                "environments": [
                    {
                        "dimensions": {"device_type": "f"},
                        "tags": ["fhcp-automated"],
                    }
                ],
            },
    ...
    def test_validate(self):
            ...
            "tests": [
                {
                    ...
                    "device_categories": [
                        {"category": "connectivity", "subcategory": "wifi"}
                    ],
                    "is_automated": False,
                },
                {
        ...
        data["tests"][1]["device_categories"].append(
            {"category": "input", "subcategory": "touchpad"}
        )
        with self.assertRaises(ValueError) as ctx:
            validate(data)
        self.assertEqual(
        ...
        data["tests"][1]["device_categories"] = [
            {"category": "input", "subcategory": "foo"}
        ]
        with self.assertRaises(ValueError) as ctx:
            validate(data)
        self.assertEqual(
