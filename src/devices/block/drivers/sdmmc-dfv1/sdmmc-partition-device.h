...
#ifndef SRC_DEVICES_BLOCK_DRIVERS_SDMMC_DFV1_SDMMC_PARTITION_DEVICE_H_
#define SRC_DEVICES_BLOCK_DRIVERS_SDMMC_DFV1_SDMMC_PARTITION_DEVICE_H_
...
#endif  // SRC_DEVICES_BLOCK_DRIVERS_SDMMC_DFV1_SDMMC_PARTITION_DEVICE_H_
