...
#ifndef SRC_DEVICES_BLOCK_DRIVERS_SDMMC_DFV1_SDMMC_TYPES_H_
#define SRC_DEVICES_BLOCK_DRIVERS_SDMMC_DFV1_SDMMC_TYPES_H_
...
#endif  // SRC_DEVICES_BLOCK_DRIVERS_SDMMC_DFV1_SDMMC_TYPES_H_
