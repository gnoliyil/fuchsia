...
TEST_F(RegisterTest, UtpTransferRequestListBaseAddress) {
  // TODO(https://fxbug.dev/124835): Writing unit test after a transfer request list is implemented
}
...
TEST_F(RegisterTest, UtpTaskManagementRequestListBaseAddress) {
  // TODO(https://fxbug.dev/124835): Writing unit test after a task management list is implemented
}
