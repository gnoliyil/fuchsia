...
#ifndef SRC_DEVICES_BLOCK_LIB_COMMON_INCLUDE_COMMON_DFV1_H_
#define SRC_DEVICES_BLOCK_LIB_COMMON_INCLUDE_COMMON_DFV1_H_
...
#endif  // SRC_DEVICES_BLOCK_LIB_COMMON_INCLUDE_COMMON_DFV1_H_
