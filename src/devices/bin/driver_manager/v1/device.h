...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DEVICE_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DEVICE_H_
...
#include "src/devices/bin/driver_manager/v1/constants.h"
...
class Device final
 ...
 private:
  ...
  void AddCompositeNodeSpec(AddCompositeNodeSpecRequestView request,
                            AddCompositeNodeSpecCompleter::Sync& _completer) override;
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DEVICE_H_
