...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_V1_TESTS_MULTIPLE_DEVICE_TEST_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_V1_TESTS_MULTIPLE_DEVICE_TEST_H_
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_V1_TESTS_MULTIPLE_DEVICE_TEST_H_
