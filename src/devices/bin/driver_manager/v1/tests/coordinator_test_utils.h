...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_V1_TESTS_COORDINATOR_TEST_UTILS_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_V1_TESTS_COORDINATOR_TEST_UTILS_H_
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_V1_TESTS_COORDINATOR_TEST_UTILS_H_
