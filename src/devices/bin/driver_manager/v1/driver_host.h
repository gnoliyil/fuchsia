...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DRIVER_HOST_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DRIVER_HOST_H_
...
class DriverHost final : public fbl::RefCounted<DriverHost>,
 ...
 public:
  ...
  fidl::WireClient<fuchsia_device_manager::DriverHostController>& controller() {
    return controller_;
  }
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DRIVER_HOST_H_
