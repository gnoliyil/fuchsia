...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DRIVER_LOADER_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DRIVER_LOADER_H_
...
class DriverLoader {
 public:
  ...
  const Driver* LoadDriverUrl(const std::string& manifest_url, bool use_full_resolver = false);
 ...
 private:
  ...
  internal::PackageResolverInterface* full_resolver_;
};

#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_V1_DRIVER_LOADER_H_
