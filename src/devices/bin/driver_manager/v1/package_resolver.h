...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_V1_PACKAGE_RESOLVER_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_V1_PACKAGE_RESOLVER_H_
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_V1_PACKAGE_RESOLVER_H_
