...
// TODO(https://fxbug.dev/23513): Don't inherit from Memory, so that Memory can have a public
// move constructor.
// TODO(https://fxbug.dev/13100): The memory is currently not transferred read-only, as we may
...
// destroyed.
// TODO(https://fxbug.dev/23513): Don't inherit from Image, so that Image can have a public move
// constructor.
