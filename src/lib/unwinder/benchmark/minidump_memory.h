...
#ifndef SRC_LIB_UNWINDER_BENCHMARK_MINIDUMP_MEMORY_H_
#define SRC_LIB_UNWINDER_BENCHMARK_MINIDUMP_MEMORY_H_
...
#endif  // SRC_LIB_UNWINDER_BENCHMARK_MINIDUMP_MEMORY_H_
