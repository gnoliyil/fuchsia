...
class ZirconLimboProvider final : public LimboProvider {
 public:
  explicit ZirconLimboProvider(fidl::UnownedClientEnd<fuchsia_io::Directory> svc_dir);
  ~ZirconLimboProvider() override = default;
 ...
 private:
  ...
  fidl::Client<fuchsia_exception::ProcessLimbo> connection_;
};
