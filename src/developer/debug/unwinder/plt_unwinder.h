...
#ifndef SRC_DEVELOPER_DEBUG_UNWINDER_PLT_UNWINDER_H_
#define SRC_DEVELOPER_DEBUG_UNWINDER_PLT_UNWINDER_H_
...
// Unwind when PC is in PLT, because lld doesn't generate CFI for PLT (fxbug.dev/112402).
class PltUnwinder {
 public:
...
#endif  // SRC_DEVELOPER_DEBUG_UNWINDER_PLT_UNWINDER_H_
