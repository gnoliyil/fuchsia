...
use {
    ...
    errors::ffx_bail,
    ffx_audio_record_args::{AudioCaptureUsageExtended, RecordCommand, SubCommand},
    ffx_core::ffx_plugin,
    fidl_fuchsia_audio_ffxdaemon::{
        AudioDaemonCreateAudioCapturerRequest, AudioDaemonProxy, VmoWrapperReadRequest,
...
pub async fn record_capture(
    ...
    let (usage_extended, buffer_size_arg, gain, mute) = match record_command.subcommand {
