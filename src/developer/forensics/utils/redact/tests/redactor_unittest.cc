...
TEST_F(RedactorTest, CheckJsonOnlyAddressesRedacted) {
  ...
  EXPECT_EQ(RedactJson("456 1234567890abcdefABCDEF0123456789 1.2.3.4"),
            "456 1234567890abcdefABCDEF0123456789 <REDACTED-IPV4: 10>");
  ...
  EXPECT_EQ(RedactJson("not_broadcast: 255.255.255.254"), "not_broadcast: <REDACTED-IPV4: 11>");
  EXPECT_EQ(RedactJson("not_link_local_multicast: 224.0.1.8"),
            "not_link_local_multicast: <REDACTED-IPV4: 12>");
