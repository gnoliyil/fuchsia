...
pub async fn query_self() {
    ...
    assert!(info.url.starts_with("fuchsia-pkg://fuchsia.com/realm_deprecated_integration_test"));
    assert!(info.url.ends_with("#meta/realm_deprecated_integration_test.cm"));
...
pub async fn explorer_get_instances() {
    ...
    for instance in instances {
        if instance.url.ends_with("#meta/realm_deprecated_integration_test.cm") {
