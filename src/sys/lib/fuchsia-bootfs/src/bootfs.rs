...
use zerocopy::{byteorder::little_endian::U32, FromBytes, FromZeroes, Unaligned};
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, FromZeroes, FromBytes, Unaligned)]
...
#[repr(C)]
#[derive(Debug, Default, FromZeroes, FromBytes, Unaligned)]
