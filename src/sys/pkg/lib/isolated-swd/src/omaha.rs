...
// TODO(https://fxbug.dev/51770): move everything except installer and policy into a shared crate,
    ...
    HR: HttpRequest,
{
    ...
    // TODO(https://fxbug.dev/117416): expose this data via the Monitor protocol, not just a single event.
