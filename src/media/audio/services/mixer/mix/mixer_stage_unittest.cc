...
TEST(MixerStageTest, Read) {
  ...
  gain_controls.Add(GainControlId{10}, GainControl(DefaultUnreadableClock()));
  gain_controls.Get(GainControlId{10}).SetGain(ScaleToDb(2.0f));
  gain_controls.Add(GainControlId{20}, GainControl(DefaultUnreadableClock()));
  ...
  for (int64_t i = 1; i <= source_count; ++i) {
    ...
    gain_controls.Add(gain_id, GainControl(DefaultUnreadableClock()));
...
TEST(MixerStageTest, ReadSilent) {
  ...
  auto& gain_controls = mixer_stage.gain_controls();
  gain_controls.Add(dest_gain_id, GainControl(DefaultUnreadableClock()));
...
TEST(MixerStageTest, SetDestGains) {
  ...
  gain_controls.Add(gain_id_1, GainControl(DefaultUnreadableClock()));
  ...
  gain_controls.Add(gain_id_2, GainControl(DefaultUnreadableClock()));
