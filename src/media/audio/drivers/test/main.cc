...
int main(int argc, char** argv) {
  ...
  // --no-virtual: Don't add+test input and output virtual_audio driver instances. Otherwise, a pair
  //   of devices (one input, one output) is configured with default settings and tested.
  ...
  device_host.RegisterTests(expect_audio_core_connected, enable_position_tests);
