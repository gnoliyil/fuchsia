...
void RealtekStream::DumpStreamPublishedLocked() {
  ...
  static const struct {
    ...
    uint32_t rate;
      ...
      {IHDA_PCM_RATE_8000, 8000},     {IHDA_PCM_RATE_11025, 11025},
      {IHDA_PCM_RATE_16000, 16000},   {IHDA_PCM_RATE_22050, 22050},
      {IHDA_PCM_RATE_32000, 32000},   {IHDA_PCM_RATE_44100, 44100},
      {IHDA_PCM_RATE_48000, 48000},   {IHDA_PCM_RATE_88200, 88200},
      {IHDA_PCM_RATE_96000, 96000},   {IHDA_PCM_RATE_176400, 176400},
      {IHDA_PCM_RATE_192000, 192000}, {IHDA_PCM_RATE_384000, 384000},
  };
