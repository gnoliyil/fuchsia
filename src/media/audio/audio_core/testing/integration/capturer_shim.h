...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_INTEGRATION_CAPTURER_SHIM_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_INTEGRATION_CAPTURER_SHIM_H_
  ...
  UltrasoundCapturerShim(TestFixture* fixture, fuchsia::ultrasound::FactoryPtr& ultrasound_factory,
    ...
    ultrasound_factory->CreateCapturer(
        fidl_.NewRequest(), [this, vmo = std::move(vmo)](auto ref_clock, auto stream_type) mutable {
          ...
          // TODO(https://fxbug.dev/42132852): Enable AddPayloadBuffer before the capturer is created.
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_INTEGRATION_CAPTURER_SHIM_H_
