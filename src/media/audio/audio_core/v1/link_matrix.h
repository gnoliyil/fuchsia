...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_LINK_MATRIX_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_LINK_MATRIX_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_LINK_MATRIX_H_
