...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_TESTING_FAKE_AUDIO_DRIVER_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_TESTING_FAKE_AUDIO_DRIVER_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_TESTING_FAKE_AUDIO_DRIVER_H_
