...
//
// TODO(https://fxbug.dev/42172801): increase this, to account for worst-case cross-clock rate mismatches and
...
// TODO(https://fxbug.dev/42172801): pad this further if needed, based on worst-case capture mix measurements.
