...
MJPEGDecoder::DecodeResult MJPEGDecoder::Decode() {
  ...
  // TODO(https://fxbug.dev/122234): Currently we only support YUV420
  ...
  // TODO(https://fxbug.dev/122235): Right now we limit the caller of stream processor to only submit one
...
VideoCodecProfile MJPEGDecoder::GetProfile() const {
  // TODO(https://fxbug.dev/122236): Fix this
