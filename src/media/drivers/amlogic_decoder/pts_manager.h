...
class PtsManager {
 public:
  ...
  //
  // TODO(https://fxbug.dev/13483): Pad the data provided to FW with AUD + padding when we know we have at
  ...
  // TODO(https://fxbug.dev/13483): This should have its own constants, not just be the max of these other
  // two.
