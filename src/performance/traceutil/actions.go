...
func newCaptureTraceConfig(f *flag.FlagSet) *captureTraceConfig {
	...
	// TODO(https://fxbug.dev/27610): It would be nice to be able to specify +category or
	...
	// TODO(https://fxbug.dev/22986): Update this message when compressed binary (fxt) traces are supported.
...
func captureTrace(config *captureTraceConfig, conn *TargetConnection, traceOutput *os.File) error {
	...
	// TODO(https://fxbug.dev/22991): The handling of embedded spaces in the command
	...
	if len(config.Command) > 0 {
		...
		// TODO(https://fxbug.dev/22958): If we talk to trace-manager directly to get
	...
	// TODO(https://fxbug.dev/27611): The target `trace` command's output is misleading.
