...
#ifndef SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_BOOT_H_
#define SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_BOOT_H_
...
#endif  // SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_BOOT_H_
