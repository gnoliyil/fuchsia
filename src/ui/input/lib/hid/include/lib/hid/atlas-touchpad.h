...
#ifndef SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_ATLAS_TOUCHPAD_H_
#define SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_ATLAS_TOUCHPAD_H_
...
#endif  // SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_ATLAS_TOUCHPAD_H_
