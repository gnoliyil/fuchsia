...
#ifndef SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_DESCRIPTOR_H_
#define SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_DESCRIPTOR_H_
...
#endif  // SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_DESCRIPTOR_H_
