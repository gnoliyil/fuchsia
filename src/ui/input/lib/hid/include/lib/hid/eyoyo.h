...
#ifndef SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_EYOYO_H_
#define SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_EYOYO_H_
...
#endif  // SRC_UI_INPUT_LIB_HID_INCLUDE_LIB_HID_EYOYO_H_
