...
#ifndef SRC_UI_INPUT_LIB_HID_PARSER_INCLUDE_LIB_HID_PARSER_PARSER_H_
#define SRC_UI_INPUT_LIB_HID_PARSER_INCLUDE_LIB_HID_PARSER_PARSER_H_
...
#endif  // SRC_UI_INPUT_LIB_HID_PARSER_INCLUDE_LIB_HID_PARSER_PARSER_H_
