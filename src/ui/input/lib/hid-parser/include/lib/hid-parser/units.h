...
#ifndef SRC_UI_INPUT_LIB_HID_PARSER_INCLUDE_LIB_HID_PARSER_UNITS_H_
#define SRC_UI_INPUT_LIB_HID_PARSER_INCLUDE_LIB_HID_PARSER_UNITS_H_
...
#endif  // SRC_UI_INPUT_LIB_HID_PARSER_INCLUDE_LIB_HID_PARSER_UNITS_H_
