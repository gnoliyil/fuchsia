...
const std::vector<std::string> kPaperRendererShaderPaths = {
    ...
    // TODO(https://fxbug.dev/42149476): the following files are not part of PaperRenderer; they're used only
...
const ShaderProgramData kAmbientLightProgramData = {
    ...
    .args = ShaderVariantArgs({
        ...
        // TODO(https://fxbug.dev/42151901): currently required by main.vert.
