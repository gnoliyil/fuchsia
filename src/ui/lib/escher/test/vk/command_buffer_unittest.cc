...
//
// TODO(https://fxbug.dev/7174): this could be extended to test the following:
...
VK_TEST_F(CommandBufferTest, Dirtyness) {
  ...
  // TODO(https://fxbug.dev/7174): ideally only submitted CommandBuffers would need to be cleaned
