...
class ImageView : public Resource {
 public:
  ...
  // TODO(https://fxbug.dev/7174): unfortunately we can't just get the recycler from
  ...
  // TODO(https://fxbug.dev/7174): for a depth-stencil texture, we may want to sample the
