...
class Image : public Resource {
 public:
  ...
  // TODO(https://fxbug.dev/7173): decide whether to deprecate format().
  ...
  // TODO(https://fxbug.dev/7174): how does this interact with swapchain_layout_?
 ...
 private:
  ...
  // TODO(https://fxbug.dev/7174): consider allowing image to have an initial layout.
