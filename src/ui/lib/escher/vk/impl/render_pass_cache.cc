...
const impl::RenderPassPtr& RenderPassCache::ObtainRenderPass(const RenderPassInfo& rpi,
  ...
  // TODO(https://fxbug.dev/42151036): take advantage of lazily-allocated memory for transient
  ...
  if (rpi.depth_stencil_attachment_info.format != vk::Format::eUndefined) {
    ...
    // TODO(https://fxbug.dev/42151036): See above.  We don't check whether the depth-stencil attachment is
  ...
  // TODO(https://fxbug.dev/42151036): pass |lazy| to RenderPass constructor; compare against
