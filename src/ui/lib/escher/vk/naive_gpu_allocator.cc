...
GpuMemPtr NaiveGpuAllocator::AllocateMemory(vk::MemoryRequirements reqs,
  ...
  // TODO(https://fxbug.dev/23951): need to manually overallocate and adjust offset to ensure
  ...
  // TODO(https://fxbug.dev/24367): cache flags for efficiency? Or perhaps change signature of
