...
GpuMemPtr NaiveGpuAllocator::AllocateMemory(vk::MemoryRequirements reqs,
  ...
  // TODO(https://fxbug.dev/42098093): need to manually overallocate and adjust offset to ensure
  ...
  // TODO(https://fxbug.dev/42098555): cache flags for efficiency? Or perhaps change signature of
