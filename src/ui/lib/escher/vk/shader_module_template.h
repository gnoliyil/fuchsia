 ...
 private:
  ...
  class Variant : public ShaderModule {
   ...
   protected:
    ...
    // TODO(https://fxbug.dev/42098023): this means that every Variant has a copy of every path
  ...
  // TODO(https://fxbug.dev/42098022): enforce lifecycle constraints, e.g. all instances must be
