 ...
 private:
  ...
  class Variant : public ShaderModule {
   ...
   protected:
    ...
    // TODO(https://fxbug.dev/23889): this means that every Variant has a copy of every path
  ...
  // TODO(https://fxbug.dev/23888): enforce lifecycle constraints, e.g. all instances must be
