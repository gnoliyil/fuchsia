...
layout(set = 0, binding = 2) uniform PointLightUniforms {
  // TODO(https://fxbug.dev/7244): don't clamp to 2.  Should provide the number of lights as
...
// TODO(https://fxbug.dev/7250): paper_shader_structs.h gives us a decent framework for
