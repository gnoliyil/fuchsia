...
// TODO(https://fxbug.dev/42151414): this code was extracted from the old ad-hoc shader generation
...
layout(set = 1, binding = 0) uniform PerObject {
  ...
  // TODO(https://fxbug.dev/42151414): See comment in main.vert: perhaps this shouldn't be per-obj.
