...
impl Scanner {
    ...
    fn process_free(&mut self, block: ScannedBlock<'_>) -> Result<(), Error> {
        // TODO(https://fxbug.dev/39975): Uncomment or delete this line depending on the resolution of https://fxbug.dev/42115938.
...
mod tests {
    ...
    // TODO(https://fxbug.dev/39975): Depending on the resolution of https://fxbug.dev/42115938, move this const out of mod test.
    ...
    fn test_reserved_fields() {
        ...
        // TODO(https://fxbug.dev/39975): Depending on the resolution of https://fxbug.dev/42115938, uncomment or delete this test.
