...
TEST_F(UefiVariableDump, EmptyVar) {
  auto capture = PrintCapture::Create();
  const std::list<efi::Variable> vars = {
      {{efi::String(u"VarName"), {}}, {}},
  };
  const std::string expected =
      "UEFI variables:\n"
      "VarName: (0)\n"
...
TEST_F(UefiVariableDump, MultiVarSameSize) {
  auto capture = PrintCapture::Create();
  const std::list<efi::Variable> vars = {
      {{efi::String(u"VarName0"), {}}, {0x00}},
      {{efi::String(u"VarName1"), {}}, {0x01}},
      {{efi::String(u"VarName2"), {}}, {0x02}},
  };
  const std::string expected =
      "UEFI variables:\n"
      "VarName0: (1)\n"
...
TEST_F(UefiVariableDump, MultiVarSmallerSize) {
  ...
  const std::list<efi::Variable> vars = {
      {{efi::String(u"VarName0"), {}}, {0x00}},
      {{efi::String(u"VarNam1"), {}}, {0x01}},
      {{efi::String(u"VarNa2"), {}}, {0x02}},
      {{efi::String(u"VarN3"), {}}, {0x03}},
  };
  const std::string expected =
      "UEFI variables:\n"
      "VarName0: (1)\n"
...
TEST_F(UefiVariableDump, MultilineValues) {
  ...
  const std::list<efi::Variable> vars = {
      {
          {efi::String(u"Var1Byte"), {}},
          {0x00},
      },
      {
          {efi::String(u"Var15Bytes"), {}},
          {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d,
           0x0e},
      },
      {
          {efi::String(u"Var16BytesSingleLine"), {}},
          {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e,
           0x0f},
      },
      {
          {efi::String(u"Var17Bytes2Lines"), {}},
          {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e,
           0x0f, 0x10},
      },
      {
          {efi::String(u"Var63Bytes4Lines"), {}},
...
TEST_F(UefiVariableDump, DumpVarNames) {
  ...
  const std::list<efi::Variable> vars = {
      {{efi::String(u"V"), {}}, {0x00}},
      {{efi::String(u"VarShort"), {}}, {0x00}},
      {{efi::String(u"VV"), {}}, {0x00}},
      {{efi::String(u"MuchLongerVariableName"), {}}, {0x00}},
      {{efi::String(u"VarWithFunnyCharsInName_!@#Δ☹☼"), {}}, {0x00}}};
  const std::string expected =
      "UEFI variables:\n"
      "V: (1)\n"
      "VarShort: (1)\n"
