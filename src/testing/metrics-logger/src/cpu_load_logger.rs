...
// TODO(https://fxbug.dev/102987): Support CPU stats logging by performance groups for X86.
        ...
        match self.cpu_stats_driver.proxy.get_cpu_stats().await {
            Ok(cpu_stats) => {
                ...
                if let Some(last_sample) = self.last_sample.take() {
                    ...
                    // TODO(https://fxbug.dev/100797): Remove system_metrics_logger category after the
