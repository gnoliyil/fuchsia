...
#ifndef SRC_STORAGE_LIB_VFS_CPP_SCOPED_VNODE_OPEN_H_
#define SRC_STORAGE_LIB_VFS_CPP_SCOPED_VNODE_OPEN_H_
...
#endif  // SRC_STORAGE_LIB_VFS_CPP_SCOPED_VNODE_OPEN_H_
