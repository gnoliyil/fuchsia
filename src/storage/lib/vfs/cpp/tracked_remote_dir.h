...
#ifndef SRC_STORAGE_LIB_VFS_CPP_TRACKED_REMOTE_DIR_H_
#define SRC_STORAGE_LIB_VFS_CPP_TRACKED_REMOTE_DIR_H_
...
#endif  // SRC_STORAGE_LIB_VFS_CPP_TRACKED_REMOTE_DIR_H_
