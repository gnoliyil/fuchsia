...
#ifndef SRC_STORAGE_LIB_VFS_CPP_JOURNAL_BACKGROUND_EXECUTOR_H_
#define SRC_STORAGE_LIB_VFS_CPP_JOURNAL_BACKGROUND_EXECUTOR_H_
...
#endif  // SRC_STORAGE_LIB_VFS_CPP_JOURNAL_BACKGROUND_EXECUTOR_H_
