...
//
// TODO(https://fxbug.dev/35904) It would be nice to provide support for "shorthand" syntax for the on_read
...
fn pseudo_directory_impl(mutable: bool, input: TokenStream) -> TokenStream {
    ...
    let (dir_var, constructor, result) = match parsed.assign_to {
        ...
        None => {
            // TODO(https://fxbug.dev/35905) Remove the underscores when span becomes Span::def_site().
