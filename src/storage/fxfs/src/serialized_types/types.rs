...
use crate::{
    ...
    object_store::{
        ...
        JournalRecordV20, JournalRecordV25, JournalRecordV29, JournalRecordV30, JournalRecordV31,
        ObjectKey, ObjectKeyV25, ObjectKeyV5, ObjectValue, ObjectValueV25, ObjectValueV29,
        ObjectValueV30, ObjectValueV31, ObjectValueV5, StoreInfo, SuperBlockHeader,
...
pub const LATEST_VERSION: Version = Version { major: 32, minor: 0 };
