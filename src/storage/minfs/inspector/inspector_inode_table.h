...
// TODO(https://fxbug.dev/42113598): Change this implementation once we have a better format
// for how to display inodes when making disk-inspect interactive.
// Refer to (https://fxbug.dev/42115545) for more details about the current implementation.
