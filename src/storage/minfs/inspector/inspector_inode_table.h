...
// TODO(https://fxbug.dev/37907): Change this implementation once we have a better format
// for how to display inodes when making disk-inspect interactive.
// Refer to (https://fxbug.dev/39660) for more details about the current implementation.
