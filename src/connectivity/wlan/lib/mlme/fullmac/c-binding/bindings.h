...
typedef struct {
  ...
  void (*start_scan)(void *device, wlan_fullmac_impl_base_start_scan_request_t *req);
  void (*connect)(void *device, wlan_fullmac_impl_base_connect_request_t *req);
  void (*reconnect)(void *device, wlan_fullmac_impl_base_reconnect_request_t *req);
  void (*auth_resp)(void *device, wlan_fullmac_impl_base_auth_resp_request_t *resp);
  void (*deauth)(void *device, wlan_fullmac_impl_base_deauth_request_t *req);
  void (*assoc_resp)(void *device, wlan_fullmac_impl_base_assoc_resp_request_t *resp);
  void (*disassoc)(void *device, wlan_fullmac_impl_base_disassoc_request_t *req);
  void (*reset)(void *device, wlan_fullmac_impl_base_reset_request_t *req);
  void (*start_bss)(void *device, wlan_fullmac_impl_base_start_bss_request_t *req);
  void (*stop_bss)(void *device, wlan_fullmac_impl_base_stop_bss_request_t *req);
  ...
  void (*eapol_tx)(void *device, wlan_fullmac_impl_base_eapol_tx_request_t *req);
