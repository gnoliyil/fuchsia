...
typedef struct {
  ...
  void (*on_wmm_status_resp)(void *ctx, zx_status_t status, const wlan_wmm_parameters_t *wmm_params);
...
typedef struct {
   ...
   */
  zx_status_t (*start)(void *device, const rust_wlan_fullmac_ifc_protocol_copy_t *ifc, zx_handle_t *out_sme_channel);
  ...
  wlan_fullmac_iface_histogram_stats_t (*get_iface_histogram_stats)(void *device, int32_t *out_status);
