...
// TODO(https://fxbug.dev/42763): HT and VHT intersections defined here are best effort only.
...
// TODO(https://fxbug.dev/29404): if tx_rx_diff is set, the intersection rule may be more complicated.
...
impl Intersect for HtCapabilities {
    fn intersect(&self, other: &Self) -> Self {
        ...
        // TODO(https://fxbug.dev/29131): Verify STBC behavior is correct.
        out.ht_cap_info = out
            .ht_cap_info
...
impl_intersect!(VhtCapabilitiesInfo {
    // TODO(https://fxbug.dev/29404): IEEE 802.11-2016 Table 9-250 - supported_cbw_set needs to consider ext_nss_bw
...
mod tests {
    ...
    // TODO(https://fxbug.dev/42763): Currently, MCS set and channel bandwidth are the most important ones. Revisit
