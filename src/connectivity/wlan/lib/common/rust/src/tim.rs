...
impl TrafficIndicationMap {
    ...
    fn n1(&self) -> usize {
        // TODO(https://fxbug.dev/40099): Consider using u64 and CTZ instead of checking all the bytes individually.
    ...
    fn n2(&self) -> usize {
        // TODO(https://fxbug.dev/40099): Consider using u64 and CLZ instead of checking all the bytes individually.
