...
// IEEE Std 802.11-2016, 9.4.1.4, Figure 9-68
enum ieee80211_beacon_caps {
  IEEE80211_BCN_CAPS_ESS                = 0x0001,
  IEEE80211_BCN_CAPS_IBSS               = 0x0002,
  IEEE80211_BCN_CAPS_CF_POLLABLE        = 0x0004,
  IEEE80211_BCN_CAPS_CF_POLL_REQ        = 0x0008,
  IEEE80211_BCN_CAPS_PRIVACY            = 0x0010,
  IEEE80211_BCN_CAPS_SHORT_PREAMBLE     = 0x0020,
  /* RESERVED - bits 6 & 7 */
  IEEE80211_BCN_CAPS_SPECT_MGMT         = 0x0100,
  IEEE80211_BCN_CAPS_QOS                = 0x0200,
  IEEE80211_BCN_CAPS_SHORT_SLOT_TIME    = 0x0400,
  IEEE80211_BCN_CAPS_APSD               = 0x0800,
  IEEE80211_BCN_CAPS_RADIO_MEASUREMENT  = 0x1000,
  /* RESERVED - bit 13 */
  IEEE80211_BCN_CAPS_DELAYED_BLOCK_ACK  = 0x4000,
  IEEE80211_BCN_CAPS_IMM_BLOCK_ACK      = 0x8000,
};
