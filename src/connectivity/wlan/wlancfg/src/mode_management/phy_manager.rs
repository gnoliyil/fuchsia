...
// TODO(https://fxbug.dev/49590): PhyManager makes the assumption that WLAN PHYs that support client and AP modes can
...
impl PhyManagerApi for PhyManager {
    ...
    async fn create_or_get_ap_iface(&mut self) -> Result<Option<u16>, PhyManagerError> {
        ...
        // TODO(https://fxbug.dev/49843): Figure out a better method of interface selection.
