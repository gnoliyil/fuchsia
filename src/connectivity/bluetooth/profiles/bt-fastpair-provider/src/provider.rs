...
impl Provider {
    ...
    async fn disable_fast_pair(&mut self) {
        ...
        // TODO(https://fxbug.dev/42056746): Close ongoing pairing procedures.
    ...
    async fn handle_host_watcher_update(&mut self, update: HostEvent) -> Result<(), Error> {
        match update {
            ...
            HostEvent::NotAvailable => {
                // TODO(https://fxbug.dev/42176031): It might make sense to shut down the GATT service.
                let _ = self.advertiser.stop_advertising().await;
...
mod tests {
    ...
    // TODO(https://fxbug.dev/42053956): This test will be obsolete if the PairingManager is resilient to
    // ordering of events.
    #[fuchsia::test]
