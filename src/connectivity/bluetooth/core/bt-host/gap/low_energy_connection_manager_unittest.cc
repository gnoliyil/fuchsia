...
TEST_F(LowEnergyConnectionManagerTest, PeerDoesNotExpireDuringTimeout) {
  ...
  // timeout.
  // TODO(https://fxbug.dev/1418): Consider configuring the cache timeout
...
TEST_F(LowEnergyConnectionManagerTest,
  ...
  // matched to the pending connection request (see https://fxbug.dev/68969). In
...
// TODO(https://fxbug.dev/2761): This test will likely become obsolete when LE
...
TEST_F(
  ...
  // TODO(https://fxbug.dev/123377): These parameters are invalid, but this test
