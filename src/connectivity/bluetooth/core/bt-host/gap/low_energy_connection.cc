...
// TODO(https://fxbug.dev/79491): Wait to update connection parameters until all
...
void LowEnergyConnection::RequestConnectionParameterUpdate(
  ...
  // TODO(https://fxbug.dev/49714): check local controller support for LL
...
void LowEnergyConnection::L2capRequestConnectionParameterUpdate(
  ...
  // TODO(https://fxbug.dev/49717): don't send request until after
...
void LowEnergyConnection::UpdateConnectionParams(
  ...
  // TODO(https://fxbug.dev/123377): Handle invalid connection parameters before
...
void LowEnergyConnection::MaybeUpdateConnectionParameters() {
  ...
  if (link_->role() == pw::bluetooth::emboss::ConnectionRole::CENTRAL) {
    ...
    // TODO(https://fxbug.dev/66031): Wait for preferred connection parameters
    // to be read.
    BT_ASSERT(peer_.is_alive());
