...
// TODO(https://fxbug.dev/91560): Only 1 connection's bandwidth is configured with the transport driver at
...
// TODO(https://fxbug.dev/89689): ScoDataChannel assumes that HCI flow control via
