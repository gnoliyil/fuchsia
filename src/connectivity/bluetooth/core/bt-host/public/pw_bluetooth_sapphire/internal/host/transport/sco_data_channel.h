...
#ifndef SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_TRANSPORT_SCO_DATA_CHANNEL_H_
#define SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_TRANSPORT_SCO_DATA_CHANNEL_H_
...
// TODO(https://fxbug.dev/91560): Only 1 connection's bandwidth is configured with the transport
// driver at a time, so performance may be poor if multiple connections are registered. The
// connection used for the current configuration is selected randomly.
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_TRANSPORT_SCO_DATA_CHANNEL_H_
