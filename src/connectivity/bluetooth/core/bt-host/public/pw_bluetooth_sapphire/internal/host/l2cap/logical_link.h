...
class LogicalLink : public hci::AclDataChannel::ConnectionInterface {
 ...
 private:
  ...
  // TODO(https://fxbug.dev/43668): save fixed channels mask and use to verify opened fixed channel
  // ids are supported
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_L2CAP_LOGICAL_LINK_H_
