...
class Phase2SecureConnections final : public PairingPhase, public PairingChannelHandler {
 ...
 private:
  ...
  // TODO(https://fxbug.dev/601): Implement Stage 1 OOB pairing (SMP Section 2.3.6.5.4).
  void StartAuthenticationStage1();
  void OnAuthenticationStage1Complete(fit::result<ErrorCode, ScStage1::Output> result);
