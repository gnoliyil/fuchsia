...
#ifndef SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_L2CAP_BREDR_DYNAMIC_CHANNEL_H_
#define SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_L2CAP_BREDR_DYNAMIC_CHANNEL_H_
...
class BrEdrDynamicChannel final : public DynamicChannel {
 ...
 private:
  ...
  // TODO(https://fxbug.dev/996): Add Extended Flow Specification steps (exchange &
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_L2CAP_BREDR_DYNAMIC_CHANNEL_H_
