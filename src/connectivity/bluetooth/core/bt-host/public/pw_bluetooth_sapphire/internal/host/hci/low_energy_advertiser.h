...
#ifndef SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_HCI_LOW_ENERGY_ADVERTISER_H_
#define SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_HCI_LOW_ENERGY_ADVERTISER_H_
...
class LowEnergyAdvertiser : public LocalAddressClient {
 public:
  ...
  struct AdvertisingOptions {
    ...
    bool anonymous;  // TODO(https://fxbug.dev/77537): anonymous advertising is currently not
                     // supported
    AdvFlags flags;
    bool include_tx_power_level;
  };
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_HCI_LOW_ENERGY_ADVERTISER_H_
