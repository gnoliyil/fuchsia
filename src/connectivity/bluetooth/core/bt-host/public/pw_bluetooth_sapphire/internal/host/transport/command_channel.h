...
class CommandChannel final {
 public:
  ...
  //
  // TODO(https://fxbug.dev/86811): Finish migration away from std::unique_ptr<CommandPacket> and
  // replace with EmbossCommandPacket.
  ...
  // events.
  //
  // TODO(https://fxbug.dev/86811): Finish migration away from EventCallback and replace with
