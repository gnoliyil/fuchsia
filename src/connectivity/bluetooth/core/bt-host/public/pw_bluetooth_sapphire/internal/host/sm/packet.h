...
#ifndef SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_SM_PACKET_H_
#define SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_SM_PACKET_H_
...
// TODO(https://fxbug.dev/48978): Merge PacketReader & ValidPacketReader types into one type for
// validating & accessing SM packets once PacketReader is no longer used.
...
class ValidPacketReader : public PacketReader {
 public:
  ...
  static fit::result<ErrorCode, ValidPacketReader> ParseSdu(const ByteBufferPtr& sdu);
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_SM_PACKET_H_
