...
#ifndef SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_SM_TEST_SECURITY_MANAGER_H_
#define SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_SM_TEST_SECURITY_MANAGER_H_
...
class TestSecurityManager final : public SecurityManager {
 ...
 private:
  ...
  TestSecurityManager(hci::LowEnergyConnection::WeakPtr link, l2cap::Channel::WeakPtr smp,
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_SM_TEST_SECURITY_MANAGER_H_
