...
class BrEdrConnectionManager final {
 public:
  ...
  // Peer's BrEdrData.
  // TODO(https://fxbug.dev/42086791): Make identical searches just search once
  ...
  // TODO(https://fxbug.dev/42087181) - implement a timeout
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_GAP_BREDR_CONNECTION_MANAGER_H_
