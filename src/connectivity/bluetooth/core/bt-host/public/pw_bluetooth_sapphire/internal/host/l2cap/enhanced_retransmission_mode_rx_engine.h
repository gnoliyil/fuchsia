...
#ifndef SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_L2CAP_ENHANCED_RETRANSMISSION_MODE_RX_ENGINE_H_
#define SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_L2CAP_ENHANCED_RETRANSMISSION_MODE_RX_ENGINE_H_
...
class EnhancedRetransmissionModeRxEngine final : public RxEngine {
 ...
 private:
  ...
  // TODO(https://fxbug.dev/42129869): Refactor these delegates into a single
  // interface for TxEngine to implement.
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_L2CAP_ENHANCED_RETRANSMISSION_MODE_RX_ENGINE_H_
