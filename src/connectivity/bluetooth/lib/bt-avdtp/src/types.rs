...
pub enum ServiceCapability {
    ...
    /// TODO(https://fxbug.dev/38280): Implement header compression specific fields to use the payload.
    ...
    /// TODO(https://fxbug.dev/38282): Implement multiplexing specific fields to use the payload.
