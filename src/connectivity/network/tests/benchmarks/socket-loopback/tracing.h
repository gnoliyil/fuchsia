...
#ifndef SRC_CONNECTIVITY_NETWORK_TESTS_BENCHMARKS_SOCKET_LOOPBACK_TRACING_H_
#define SRC_CONNECTIVITY_NETWORK_TESTS_BENCHMARKS_SOCKET_LOOPBACK_TRACING_H_
...
#endif  // SRC_CONNECTIVITY_NETWORK_TESTS_BENCHMARKS_SOCKET_LOOPBACK_TRACING_H_
