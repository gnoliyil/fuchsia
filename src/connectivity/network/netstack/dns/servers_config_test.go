...
var (
	addr1 = tcpip.FullAddress{
		Addr: addrFromString("\xfe\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01"),
	...
	addr3 = tcpip.FullAddress{
		Addr: addrFromString("\xfe\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02"),
		Port: dns.DefaultDNSPort + 2,
	}
	// Should assume default port of 53.
	addr4 = tcpip.FullAddress{
		Addr: addrFromString("\xfe\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03"),
		NIC:  5,
	}
	addr5 = tcpip.FullAddress{
		Addr: addrFromString("\x0a\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x05"),
		Port: dns.DefaultDNSPort,
	}
	addr6 = tcpip.FullAddress{
		Addr: addrFromString("\x0a\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06"),
		Port: dns.DefaultDNSPort,
	}
	addr7 = tcpip.FullAddress{
		Addr: addrFromString("\x0a\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x07"),
		Port: dns.DefaultDNSPort,
	}
	addr8 = tcpip.FullAddress{
		Addr: addrFromString("\x0a\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08"),
		Port: dns.DefaultDNSPort,
	}
	addr9 = tcpip.FullAddress{
		Addr: addrFromString("\x0a\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x09"),
		Port: dns.DefaultDNSPort,
	}
	addr10 = tcpip.FullAddress{
		Addr: addrFromString("\x0a\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x0a"),
		Port: dns.DefaultDNSPort,
	}
)
