...
pub type bpf_cgroup_iter_order = crate::arm64_types::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub type _bindgen_ty_14 = crate::arm64_types::c_uint;
...
pub type _bindgen_ty_15 = crate::arm64_types::c_ulong;
pub const BPF_F_CURRENT_NETNS: _bindgen_ty_16 = -1;
pub type _bindgen_ty_16 = crate::arm64_types::c_int;
...
pub type _bindgen_ty_49 = crate::arm64_types::c_uint;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, AsBytes, FromBytes)]
pub struct nlattr {
    pub nla_len: __u16,
