...
use crate::{mm::PAGE_SIZE, types::signals::SigSet, types::user_address::UserAddress};
...
pub const SIG_DFL: UserAddress = UserAddress::const_from(0);
pub const SIG_IGN: UserAddress = UserAddress::const_from(1);
pub const SIG_ERR: UserAddress = UserAddress::const_from(u64::MAX);
