...
use crate::{
    ...
    types::{
        c_char, ip6t_get_entries, ip6t_getinfo, ip6t_replace, ipt_get_entries, ipt_getinfo,
        ipt_replace, nf_inet_hooks_NF_INET_NUMHOOKS, xt_counters, xt_counters_info,
        xt_get_revision, IP6T_SO_GET_ENTRIES, IP6T_SO_GET_INFO, IP6T_SO_GET_REVISION_MATCH,
