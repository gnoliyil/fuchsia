...
pub fn decode_page_fault_exception_report(
    ...
    // TODO(https://fxbug.dev/128554): Is there a way to distinguish access and page-not-present faults?
...
pub fn get_signal_for_general_exception(
    ...
    // TODO(https://fxbug.dev/128554) Return SIGFPE for FP exceptions.
    None
}
