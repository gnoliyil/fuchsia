...
use crate::{
    ...
    types::{
        OpenFlags, __kernel_old_dev_t,
        device_type::{DeviceType, LOOP_MAJOR},
        loop_info, loop_info64, uapi, BLKFLSBUF, BLKGETSIZE, BLKGETSIZE64, LOOP_CHANGE_FD,
        LOOP_CLR_FD, LOOP_CONFIGURE, LOOP_CTL_ADD, LOOP_CTL_GET_FREE, LOOP_CTL_REMOVE,
        LOOP_GET_STATUS, LOOP_GET_STATUS64, LOOP_SET_BLOCK_SIZE, LOOP_SET_CAPACITY,
