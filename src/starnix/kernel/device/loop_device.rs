...
use crate::{
    ...
    types::{
        ...
        BLKFLSBUF, BLKGETSIZE, BLKGETSIZE64, LOOP_CHANGE_FD, LOOP_CLR_FD, LOOP_CONFIGURE,
        ...
        LOOP_SET_STATUS64, LO_FLAGS_AUTOCLEAR, LO_FLAGS_DIRECT_IO, LO_FLAGS_PARTSCAN,
        LO_FLAGS_READ_ONLY, LO_KEY_SIZE,
    },
};
