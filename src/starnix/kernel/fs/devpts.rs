...
use crate::{
    ...
    syscalls::{
        ...
        OpenFlags, SyscallArg, SyscallResult, DEVPTS_SUPER_MAGIC, FIOASYNC, FIOCLEX, FIONBIO,
        FIONCLEX, FIONREAD, FIOQSIZE, SUCCESS, TCFLSH, TCGETA, TCGETS, TCGETX, TCSBRK, TCSBRKP,
