...
#ifndef SRC_STARNIX_TESTS_SYSCALLS_SYSCALL_MATCHERS_H_
#define SRC_STARNIX_TESTS_SYSCALLS_SYSCALL_MATCHERS_H_
...
#endif  // SRC_STARNIX_TESTS_SYSCALLS_SYSCALL_MATCHERS_H_
