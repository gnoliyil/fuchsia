...
#define DMESSAGE MAGMA_DMESSAGE

#define DRET MAGMA_DRET

#define DRET_MSG MAGMA_DRET_MSG

#define DRETF MAGMA_DRETF

#define DRETP MAGMA_DRETP

#define UNIMPLEMENTED MAGMA_UNIMPLEMENTED

#define ATTRIBUTE_UNUSED MAGMA_ATTRIBUTE_UNUSED
