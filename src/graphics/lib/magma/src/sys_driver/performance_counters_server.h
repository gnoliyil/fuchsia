...
#ifndef SRC_GRAPHICS_LIB_MAGMA_SRC_SYS_DRIVER_PERFORMANCE_COUNTERS_SERVER_H_
#define SRC_GRAPHICS_LIB_MAGMA_SRC_SYS_DRIVER_PERFORMANCE_COUNTERS_SERVER_H_
