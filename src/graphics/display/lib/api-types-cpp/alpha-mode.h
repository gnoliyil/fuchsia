...
// Equivalent to the FIDL type [`fuchsia.hardware.display.types/AlphaMode`] and
// the banjo type [`fuchsia.hardware.display.controller/Alpha`].
//
// See `::fuchsia_hardware_display_types::wire::AlphaMode` for references.
using AlphaMode = fuchsia_hardware_display_types::wire::AlphaMode;
