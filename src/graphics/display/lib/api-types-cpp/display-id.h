...
constexpr inline DisplayId ToDisplayId(
    fuchsia_hardware_display_types::wire::DisplayId fidl_display_id) {
...
constexpr inline fuchsia_hardware_display_types::wire::DisplayId ToFidlDisplayId(
