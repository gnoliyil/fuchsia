...
TEST(DmtTimingToTimingParams, InterlacedWithAlternatingVblank) {
...
TEST(DmtTimingToTimingParams, InterlacedWithConstantVblank) {
  constexpr DmtTiming kDmtTiming = {
      .id = 0x99,
...
TEST(DmtTimingToTimingParams, Progressive) {
  constexpr DmtTiming kDmtTiming = {
      .id = 0x99,
...
TEST(DmtTimingToTimingParams, ProgressiveWithBorder) {
  constexpr DmtTiming kDmtTiming = {
      .id = 0x99,
  ...
  EXPECT_EQ(kConverted.horizontal_sync_pulse, 0x02'02u);
  EXPECT_EQ(kConverted.horizontal_blanking, 0x06'36u);
  EXPECT_EQ(kConverted.vertical_addressable, 0x07'07u);
  EXPECT_EQ(kConverted.vertical_front_porch, 0x03'33u);
  EXPECT_EQ(kConverted.vertical_sync_pulse, 0x04'04u);
  EXPECT_EQ(kConverted.vertical_blanking, 0x0c'7cu);
  EXPECT_EQ(kConverted.flags, timing_params_t::kPositiveHsync);
  EXPECT_EQ(kConverted.vertical_refresh_e2, 48'13u);
}
