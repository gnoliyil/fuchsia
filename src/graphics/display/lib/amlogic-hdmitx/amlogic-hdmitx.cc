...
HdmiTransmitter::HdmiTransmitter(
  ...
  // TODO(fxbug.dev/123426): `silicon_provider_service_smc` may be invalid in
...
void CalculateTxParam(const display::DisplayTiming& display_timing,
  ...
  //
  // TODO(fxbug.dev/136194): Revise the AVI InfoFrame naming and move the
  ...
  // TODO(fxbug.dev/136231): Revise AVI InfoFrame values set by the driver.
