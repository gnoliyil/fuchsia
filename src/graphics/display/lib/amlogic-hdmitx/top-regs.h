...
#ifndef SRC_GRAPHICS_DISPLAY_LIB_AMLOGIC_HDMITX_TOP_REGS_H_
#define SRC_GRAPHICS_DISPLAY_LIB_AMLOGIC_HDMITX_TOP_REGS_H_
...
#endif  // SRC_GRAPHICS_DISPLAY_LIB_AMLOGIC_HDMITX_TOP_REGS_H_
