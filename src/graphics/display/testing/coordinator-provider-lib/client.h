...
#ifndef SRC_GRAPHICS_DISPLAY_TESTING_COORDINATOR_PROVIDER_LIB_CLIENT_H_
#define SRC_GRAPHICS_DISPLAY_TESTING_COORDINATOR_PROVIDER_LIB_CLIENT_H_
...
#endif  // SRC_GRAPHICS_DISPLAY_TESTING_COORDINATOR_PROVIDER_LIB_CLIENT_H_
