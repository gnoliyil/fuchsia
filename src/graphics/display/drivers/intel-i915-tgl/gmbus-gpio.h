...
#ifndef SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_I915_TGL_GMBUS_GPIO_H_
#define SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_I915_TGL_GMBUS_GPIO_H_
...
#endif  // SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_I915_TGL_GMBUS_GPIO_H_
