...
bool i2c_scl(fdf::MmioBuffer* mmio_space, registers::Ddi ddi, bool hi) {
...
// For bit banging i2c over the gpio pins
void i2c_sda(fdf::MmioBuffer* mmio_space, registers::Ddi ddi, bool hi) {
  auto gpio = registers::GpioCtl::Get(ddi).FromValue(0);
...
// For bit banging i2c over the gpio pins
bool i2c_send_byte(fdf::MmioBuffer* mmio_space, registers::Ddi ddi, uint8_t byte) {
