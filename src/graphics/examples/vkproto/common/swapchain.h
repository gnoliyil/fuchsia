...
#ifndef SRC_GRAPHICS_EXAMPLES_VKPROTO_COMMON_SWAPCHAIN_H_
#define SRC_GRAPHICS_EXAMPLES_VKPROTO_COMMON_SWAPCHAIN_H_
...
#endif  // SRC_GRAPHICS_EXAMPLES_VKPROTO_COMMON_SWAPCHAIN_H_
