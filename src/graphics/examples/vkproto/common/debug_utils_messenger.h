...
#ifndef SRC_GRAPHICS_EXAMPLES_VKPROTO_COMMON_DEBUG_UTILS_MESSENGER_H_
#define SRC_GRAPHICS_EXAMPLES_VKPROTO_COMMON_DEBUG_UTILS_MESSENGER_H_
...
#endif  // SRC_GRAPHICS_EXAMPLES_VKPROTO_COMMON_DEBUG_UTILS_MESSENGER_H_
