...
#ifndef SRC_PROC_TESTS_SYSCALLS_PROC_TEST_H_
#define SRC_PROC_TESTS_SYSCALLS_PROC_TEST_H_

#include <sys/mount.h>

#include <gtest/gtest.h>

#include "src/proc/tests/syscalls/syscall_matchers.h"
...
#endif  // SRC_PROC_TESTS_SYSCALLS_PROC_TEST_H_
