...
class TypesTest(unittest.TestCase):
    def test_serialize(self):
        ...
        deserialized = {
            "title": "Add protocol method",
            "fidl": {
                "before": {"source": "before.test.fidl", "instructions": []},
                "after": {"source": "after.test.fidl", "instructions": []},
            },
            "bindings": {
                "hlcpp": {
                    "starting_fidl": "before",
    ...
    def test_fidl(self):
        ...
        self.assertEqual(
            reversed_defs,
            {
                ...
                "step_01_during": FidlDef(
                    source="fidl/step_01_during.test.fidl",
                    instructions=["add/remove transitional"],
                ),
                "step_03_after": FidlDef(
    ...
    def test_src_fidl_assisted(self):
        ...
        transition = Steps(
            ...
            steps=[
                ...
                SourceStep(
                    step_num=3, source="hlcpp/step_03_after.cc", instructions=[]
                ),
