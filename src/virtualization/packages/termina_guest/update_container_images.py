...
SERVER_URL = (
    "https://storage.googleapis.com/cros-containers/" + CHROMEOS_MILESTONE + "/"
)
...
def download_images():
    ...
    with urllib.request.urlopen(SERVER_URL + "streams/v1/index.json") as index:
        ...
        with urllib.request.urlopen(
            SERVER_URL + data["index"]["images"]["path"]
        ) as images:
...
def main():
    ...
    if options.publish:
        ...
        download_images()
        print(
            "Images have been downloaded into //prebuilt. Once you're happy with them, upload to"
        )
        print("CIPD with:")
        print("")
