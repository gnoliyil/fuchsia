...
zx_status_t IoApic::Write(uint64_t addr, const IoValue& value) {
  switch (addr) {
    ...
    case kIoApicEOIR: {
      ...
      // this register.
      //
      // TODO(https://fxbug.dev/42157839): Correctly support level-triggered interrupts.
      return ZX_OK;
    }
    default:
...
zx::result<IoApic::Action> IoApic::WriteRedirectEntryLocked(uint32_t global_irq, RedirectBits bits,
  ...
  //
  // TODO(https://fxbug.dev/42157839): We do not correctly support level-triggered interrupts
