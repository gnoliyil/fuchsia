...
#ifndef LIB_FIDL_DRIVER_CPP_INTERNAL_WIRE_CLIENT_DETAILS_H_
#define LIB_FIDL_DRIVER_CPP_INTERNAL_WIRE_CLIENT_DETAILS_H_
...
#endif  // LIB_FIDL_DRIVER_CPP_INTERNAL_WIRE_CLIENT_DETAILS_H_
