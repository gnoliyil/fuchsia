...
// TODO(https://fxbug.dev/25053): Use a more useful distribution for types such as bool.
FUZZING_STATIC(bool);
...
FUZZING_STATIC(::fidl::internal::FrameworkErr);
...
//
// TODO(https://fxbug.dev/25053): Generate a distribution of legitimate and illegitimate handles.
template <typename T>
...
//
// TODO(https://fxbug.dev/25053): Consume some input bytes to allocate pseudorandom number of items.
