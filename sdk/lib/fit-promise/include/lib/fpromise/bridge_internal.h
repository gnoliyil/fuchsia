...
#ifndef LIB_FPROMISE_BRIDGE_INTERNAL_H_
#define LIB_FPROMISE_BRIDGE_INTERNAL_H_
...
class bridge_state final {
 ...
 private:
  ...
  // TODO(https://fxbug.dev/42117467): It should be possible to implement a lock-free algorithm
...
#endif  // LIB_FPROMISE_BRIDGE_INTERNAL_H_
