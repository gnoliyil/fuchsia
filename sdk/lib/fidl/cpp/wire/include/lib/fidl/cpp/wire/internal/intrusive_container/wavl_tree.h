...
struct WAVLTreeNodeStateBase
 ...
 public:
  ...
  ~WAVLTreeNodeStateBase() {
    ...
    if constexpr (!(kNodeOptions & fidl::internal_wavl::NodeOptions::AllowClearUnsafe)) {
...
class __POINTER(KeyType_) WAVLTree {
 ...
 public:
  ...
  using CheckerType = ::fidl::internal_wavl::tests::intrusive_containers::WAVLTreeChecker;
  ...
  // clear_unsafe
  //
  // See comments in fidl::internal_wavl/intrusive_single_list.h
...
//
// See comments on ContainableBaseClasses<> in fidl::internal_wavl/intrusive_container_utils.h
// for more details.
//
