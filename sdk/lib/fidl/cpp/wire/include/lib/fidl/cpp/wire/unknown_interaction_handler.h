...
#ifndef LIB_FIDL_CPP_WIRE_UNKNOWN_INTERACTION_HANDLER_H_
#define LIB_FIDL_CPP_WIRE_UNKNOWN_INTERACTION_HANDLER_H_
...
#endif  // LIB_FIDL_CPP_WIRE_UNKNOWN_INTERACTION_HANDLER_H_
