...
struct DecoderEncoderStatus {
  ...
  // TODO(https://fxbug.dev/42086143): Add first handles for koid check.
  ...
  // TODO(https://fxbug.dev/42086143): Add second handles for koid check.
};
...
DecoderEncoderStatus DecoderEncoderImpl(uint8_t* bytes, uint32_t num_bytes, zx_handle_t* handles,
  ...
  // TODO(https://fxbug.dev/42121756): Use FIDL at rest.
  ...
  // TODO(https://fxbug.dev/42086143): Add handles for koid check.
