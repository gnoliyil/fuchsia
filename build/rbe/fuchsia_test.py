...
class RemoteExecutableTests(unittest.TestCase):
    ...
    def test_linux_x64(self):
        self.assertEqual(
            fuchsia.remote_executable(
                '../prebuilt/some/tool/linux-x64/bin/tool1'),
            '../prebuilt/some/tool/linux-x64/bin/tool1',
        )
    ...
    def test_mac_arm64(self):
        self.assertEqual(
            fuchsia.remote_executable(
                '../prebuilt/some/tool/mac-arm64/bin/tool2'),
            '../prebuilt/some/tool/linux-x64/bin/tool2',
        )
...
class RustStdlibDirTests(unittest.TestCase):
    ...
    def test_substitution(self):
        ...
        self.assertIn(target, fuchsia.rust_stdlib_dir(target))
        ...
        with mock.patch.object(os.path, 'isfile',
            ...
            list(
                fuchsia.sysroot_files(
                    sysroot_dir='path/to/built/sysroot',
