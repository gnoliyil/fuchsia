...
"""
    ...
    # Some //vendor/... BUILD.bazel files are still including
    # //:fuchsia_build_config.bzl so create one that re-exports the content
    # of @fuchsia_build_config//:defs.bzl instead.
    generated.add_file(
        os.path.join("workspace", "fuchsia_build_config.bzl"),
        """# Temporary file, remove this once all //vendor/... BUILD.bazel file properly
# include @fuchsia_build_config//:defs.bzl instead of this one.

load("@fuchsia_build_config//:defs.bzl", _build_config = "build_config")
