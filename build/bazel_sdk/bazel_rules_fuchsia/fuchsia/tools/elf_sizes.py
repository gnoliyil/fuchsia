...
def main():
    ...
    parser.add_argument('--bootfs-dir', help='bootfs content', metavar='DIR', required=True)
    parser.add_argument('--zbi', help='Read zbi.json', metavar='FILE', required=True)
    parser.add_argument('--blobs', help='Read blobs.json', metavar='FILE', required=True)
    parser.add_argument('--sizes', help='Write elf_sizes.json', metavar='FILE', required=True)
