...
// FIXME(http://fxbug.dev/132950): We can unfork tracing-core once it no longer vendors the `spin`
// crate.
#[cfg(not(feature = "std"))]
mod spin {
    std::compile_error!("The fuchsia fork of tracing-core requires the `std` feature");
}
