...
// TODO-rvbringup: add support for RISC-V for all of these features.
...
zx_status_t arch_get_fp_regs(Thread* thread, zx_thread_state_fp_regs_t* out) { return ZX_ERR_NOT_SUPPORTED; }

zx_status_t arch_set_fp_regs(Thread* thread, const zx_thread_state_fp_regs_t* in) { return ZX_ERR_NOT_SUPPORTED; }
...
zx_status_t arch_get_debug_regs(Thread* thread, zx_thread_state_debug_regs_t* out) { return ZX_ERR_NOT_SUPPORTED; }

zx_status_t arch_set_debug_regs(Thread* thread, const zx_thread_state_debug_regs_t* in) {
  return ZX_ERR_NOT_SUPPORTED;
}

zx_status_t arch_get_x86_register_fs(Thread* thread, uint64_t* out) { return ZX_ERR_NOT_SUPPORTED; }

zx_status_t arch_set_x86_register_fs(Thread* thread, const uint64_t* in) {
  return ZX_ERR_NOT_SUPPORTED;
}

zx_status_t arch_get_x86_register_gs(Thread* thread, uint64_t* out) { return ZX_ERR_NOT_SUPPORTED; }

zx_status_t arch_set_x86_register_gs(Thread* thread, const uint64_t* in) {
  return ZX_ERR_NOT_SUPPORTED;
}

uint8_t arch_get_hw_breakpoint_count() { return ZX_ERR_NOT_SUPPORTED; }

uint8_t arch_get_hw_watchpoint_count() { return ZX_ERR_NOT_SUPPORTED; }
