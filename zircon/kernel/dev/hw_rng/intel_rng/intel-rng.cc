...
static ssize_t get_entropy_from_cpu(void* buf, size_t len) {
  /* TODO(security, https://fxbug.dev/30930): Move this to a shared kernel/user lib, so we can write
...
static ssize_t get_entropy_from_rdrand(void* buf, size_t len) {
  // TODO(security, https://fxbug.dev/30929): This method is not compliant with Intel's "Digital Random
