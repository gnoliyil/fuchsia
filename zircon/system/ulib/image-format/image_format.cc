...
fpromise::result<PixelFormatAndModifier> ImageFormatConvertZxToSysmem_v2(
  ...
  v2b.pixel_format_modifier = fuchsia_images2::kFormatModifierLinear;
  PixelFormat out;
  switch (zx_pixel_format) {
    case ZX_PIXEL_FORMAT_RGB_565:
      out = PixelFormat::kRgb565;
      break;

    case ZX_PIXEL_FORMAT_RGB_332:
      out = PixelFormat::kRgb332;
      break;

    case ZX_PIXEL_FORMAT_RGB_2220:
      out = PixelFormat::kRgb2220;
      break;

    case ZX_PIXEL_FORMAT_ARGB_8888:
      out = PixelFormat::kBgra32;
      break;
...
bool ImageFormatConvertZxToSysmem(zx_pixel_format_t zx_pixel_format,
  ...
  pixel_format_out->type =
      static_cast<fuchsia_sysmem_PixelFormatType>(pixel_format_v2.pixel_format);
  pixel_format_out->has_format_modifier = true;
  pixel_format_out->format_modifier.value = pixel_format_v2.pixel_format_modifier;
  return true;
}
#endif
